<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    ...
    <path d="M8 9V8C8 5.79086 9.79086 4 12 4M16 9V8C16 5.79086 14.2091 4 12 4M12 4V3" stroke="currentColor"
      stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M12 17V21M12 21H14M12 21H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
