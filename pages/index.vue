...
const mapLink =
  "https://yandex.ru/map-widget/v1/?um=constructor%3A63ccde52ac73bdd72e9a96d3dfe386069f6869a31541ddf24841c7908d8bc31b&amp;source=constructor";
  ...
  <Container class="flex flex-col gap-14">
    ...
    <section class="flex flex-col gap-6">
      <h2 class="text-3xl font-bold">
        {{ t("screen.about.subtitle[0]") }} <br />{{
          t("screen.about.subtitle[1]")
        }}
      </h2>
    ...
    <section class="grid lg:grid-cols-2 gap-4">
      <img
        ...
        alt="events"
        class="lg:max-w-md object-cover aspect-square mx-auto"
      />
